...
class listClass extends StatefulWidget{
  ...
  //listClass({this.userId, Key? key}) : super(key: key);
   String userId;
   bool isfaculty;
   listClass(this.userId, this.isfaculty, {super.key});
...
class Myapp extends State<listClass> {
  ...
  Future fetchData() async {
      ...
      response =
      await http.get(Uri.parse('http://10.0.2.2:5000/viewFacultyEnrolls/$userId'));
        ...
        child: GridView(
          ...
          children: [
              ...
              onTap: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => takeAttendance(courseCode,userId,isfaculty!)),
                );
              },
            child: Container(
              decoration: BoxDecoration(
              borderRadius: BorderRadius.circular(20), color: AppColor.card),
              child: Center(
