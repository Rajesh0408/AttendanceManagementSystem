...
import 'package:myapp/frontEnd/post/postLoginDetails.dart';
import 'package:myapp/frontEnd/signup_faculty.dart';
import 'package:myapp/frontEnd/signup_student.dart';
                      ...
                      if (result!.isEmpty) {
                        ...
                        if(result?['role']=="Faculty & Advisor"){
                          Navigator.push(context, MaterialPageRoute(
                              builder: (context) => listClass(userId,false)));
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                          ...
                          Navigator.push(context, MaterialPageRoute(
                              builder: (context) => listClass(userId,true)));
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                              content: Text("LogIn successful"),
                              duration: Duration(seconds: 2),
          ...
          decoration: InputDecoration(
            ...
            enabledBorder: OutlineInputBorder(
              borderSide: BorderSide(
                color:
                errorText.startsWith('Invalid') ? Colors.red : Colors.green,
              ),
            ),
